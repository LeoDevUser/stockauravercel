    ...
    <div className="results-page">
      ...
      <div className="nav">
        ...
        <div className="ticker-info">
          ...
          <h2>
            Ticker: {ticker}&emsp;&emsp;{results.current} {results.currency}
          </h2>
        </div>
        ...
        <div className="parameter-group">
          <label>
            ...
            <input
              ...
              value={tradeSize}
              onChange={(e) =>
                setTradeSize(parseFloat(e.target.value) || 10000)
              }
              step={1000}
              min={1}
            />
          ...
          <small>Capital allocated to this trade</small>
        </div>
        ...
        <div className="parameter-group">
          <label>
            ...
            <input
              ...
              value={riskTolerance}
              onChange={(e) =>
                setRiskTolerance(parseFloat(e.target.value) || 2)
              }
              step={0.5}
              min={0.1}
              max={100}
        ...
        <div className="parameter-group">
          <label>
            ...
            <input
              ...
              onChange={(e) =>
                setTransactionCost(parseFloat(e.target.value) / 100)
              }
              step={0.001}
              min={0}
            />
          ...
          <small>
            Per trade commission (IB $0.005, Robinhood $0, Traditional 0.1-1%)
          </small>
        </div>
      </div>
      ...
      <div className="results-grid">
        ...
        <div className="results-grid-row">
          ...
          <div className="section header-stats">
            ...
            {results.trend_direction && (
              <div className="stat trend-stat">
                ...
                <div
                  className={`trend-value trend-${results.trend_direction.toLowerCase()}`}
                >
                ...
                {results.recent_return_1y && (
                  <small>
                    {(results.recent_return_1y * 100).toFixed(2)}% (1-year
                    return)
                  </small>
                )}
              </div>
            ...
            <div className="stat">
              ...
              <div className="progress-bar">
                <div
                  ...
                  style={{
                    width: `${(results.predictability_score / 5) * 100}%`,
                  }}
                />
              </div>
            </div>
            ...
            {results.Return !== null && (
              <div className="stat">
                ...
                <div
                  className={`value ${results.Return < 0 ? 'negative' : 'positive'}`}
                >
          ...
          <div className="section statistical-engine">
            ...
            >
              These 5 tests determine the{' '}
              <strong style={{ color: '#ff9500' }}>Predictability Score</strong>
              . Each passed test = 1 point.
            </div>

            {/* Test 1: Momentum Correlation */}
            <div className="metric-box">
              <label>
                1. Momentum Correlation (3-Day Blocks)
                <Tooltip content={tooltipContent.momentumCorrelation} />
              </label>
              {results.momentum_corr !== null ? (
                <>
                  <div
                    className={`status ${Math.abs(results.momentum_corr) > 0.08 ? 'significant' : 'insignificant'}`}
                  >
                  ...
                  {results.momentum_corr_oos !== null && (
                    <small style={{ display: 'block', marginTop: '0.4em' }}>
                      Out-of-Sample:{' '}
                      {(results.momentum_corr_oos * 100).toFixed(1)}%
                      {Math.abs(
                        results.momentum_corr - results.momentum_corr_oos
                      ) > 0.1 && (
            ...
            <div className="metric-box">
              <label>
                2. Market Regime (DFA / Hurst)
                <Tooltip content={tooltipContent.hurstExponent} />
              </label>
              {results.hurst !== null ? (
                <div className="gauge-container">
                  <div
                    className={`status ${results.hurst_significant && (results.hurst > 0.55 || results.hurst < 0.45) ? 'significant' : 'insignificant'}`}
                  >
                    {results.hurst_significant &&
                    (results.hurst > 0.55 || results.hurst < 0.45)
                  ...
                  >
                    ...
                    {results.hurst_oos !== null && (
                      <> | Out-Sample: {results.hurst_oos.toFixed(3)}</>
                    )}
                  </div>
                  {results.hurst_shuffled_mean !== null && (
                    <small style={{ color: '#777' }}>
                      Shuffled baseline:{' '}
                      {results.hurst_shuffled_mean.toFixed(3)}
                    </small>
                  )}
                </div>
              ) : (
            ...
            <div className="metric-box">
              <label>
                3. Mean Reversion After Extremes
              ...
              results.mean_rev_down !== null ? (
                <>
                  <div
                    className={`status ${Math.abs(results.mean_rev_up) > 0.003 && Math.abs(results.mean_rev_down) > 0.003 ? 'significant' : 'insignificant'}`}
                  >
                  ...
                  >
                    <span style={{ color: '#aaa' }}>
                      ...
                      <strong
                        style={{
                          color:
                            results.mean_rev_up < 0 ? '#22c55e' : '#f59e0b',
                        }}
                      >
                    ...
                    <span style={{ color: '#aaa' }}>
                      ...
                      <strong
                        style={{
                          color:
                            results.mean_rev_down > 0 ? '#22c55e' : '#f59e0b',
                        }}
                      >
                  ...
                  {(results.mean_rev_up_oos !== null ||
                    ...
                    >
                      OOS: After Up{' '}
                      {results.mean_rev_up_oos !== null
                        ? `${(results.mean_rev_up_oos * 100).toFixed(2)}%`
                        : 'N/A'}
                      {' | '}After Down{' '}
                      {results.mean_rev_down_oos !== null
                        ? `${(results.mean_rev_down_oos * 100).toFixed(2)}%`
                        : 'N/A'}
                    </div>
                  )}
                </>
            ...
            <div className="metric-box">
              <label>
                4. Regime Stability (Out-of-Sample)
                <Tooltip content={tooltipContent.regimeStability} />
              </label>
              {results.regime_stability !== null ? (
                <>
                  <div
                    className={`status ${results.regime_stability >= 0.5 ? 'significant' : 'insignificant'}`}
                  >
                    {results.regime_stability >= 1.0
            ...
            {results.volume_price_data && (
              <div className="metric-box">
                  ...
                  <Tooltip
                    content={
                      <>
                        ...
                        <p>
                          Tests whether volume supports the current trend
                          direction.
                        </p>
                        <ul>
                          <li>
                            <strong>Uptrend:</strong> Up-day volume should
                            exceed down-day volume by &gt;10%
                          </li>
                          <li>
                            <strong>Downtrend:</strong> Down-day volume should
                            exceed up-day volume by &gt;10%
                          </li>
                          <li>
                            <strong>Neutral:</strong> No clear trend to confirm
                          </li>
                        </ul>
                        <p>
                          The ratio shows average volume on up days divided by
                          average volume on down days. A ratio &gt;1.10 in an
                          uptrend or &lt;0.90 in a downtrend means volume
                          confirms the trend.
                        </p>
                        <p>
                          <strong>
                            Counts as 1 point toward predictability score if
                            confirming.
                          </strong>
                        </p>
                      </>
                ...
                <div
                  className={`status ${results.volume_price_data.vp_confirming ? 'significant' : 'insignificant'}`}
                >
                  {results.volume_price_data.vp_confirming
                    ? '✓ Passed — Volume confirms trend'
                    : '✗ Failed — Volume does not confirm trend'}
                </div>
                <div
                  style={{
                    marginTop: '0.75em',
                ...
                >
                  <span style={{ color: '#aaa' }}>
                    ...
                    <strong
                      style={{
                        color:
                          results.volume_price_data.vp_ratio > 1.1
                            ? '#22c55e'
                            : results.volume_price_data.vp_ratio < 0.9
                              ? '#ef4444'
                              : '#f59e0b',
                      }}
                    >
                  ...
                  <span style={{ color: '#aaa' }}>
                    ...
                    <strong
                      style={{
                        color:
                          results.volume_price_data.trend_for_vp === 'UP'
                            ? '#22c55e'
                            : results.volume_price_data.trend_for_vp === 'DOWN'
                              ? '#ef4444'
                              : '#f59e0b',
                      }}
                    >
                ...
                >
                  <span>
                    Avg Vol Up Days:{' '}
                    {results.volume_price_data.avg_vol_up.toLocaleString(
                      undefined,
                  ...
                  <span>
                    Avg Vol Down Days:{' '}
                    {results.volume_price_data.avg_vol_down.toLocaleString(
                      undefined,
                      { maximumFractionDigits: 0 }
                    )}
                  </span>
        ...
        <div className="section visual-summary">
          ...
          <div className="summary-text">
            ...
            {results.hurst !== null && (
              <p>
                <strong>{ticker}</strong> is in a{' '}
                <span className={getRegimeDescription().toLowerCase()}>
                  {getRegimeDescription()}
                </span>{' '}
                regime with{' '}
                {results.adf_pvalue && results.adf_pvalue < 0.05
                  ? 'stationary'
                  : 'non-stationary'}{' '}
                price action.
                {results.trend_direction && (
                  <>
                    {' '}
                    Currently in a{' '}
                    <strong>{results.trend_direction} trend</strong>.
                  </>
                )}
                {results.hurst_significant === false && (
                  <>
                    ...
                    <span style={{ color: '#f59e0b' }}>
                      (Note: regime not statistically significant vs random)
                    </span>
                  </>
                )}
              </p>
            ...
            {results.Return && results.Return < -20 && (
              ...
              >
                ⚠⚠⚠ SEVERE WARNING: This stock has lost{' '}
                {Math.abs(results.Return).toFixed(1)}% annually. Consider
                bankruptcy risk before trading.
              </p>
            )}
          </div>
        </div>
        ...
        <div className="metrics-grid">
          {results.adf_pvalue !== null && (
            <div className="metric-card">
              ...
              <div
                className="value"
                style={{
                  color: results.adf_pvalue < 0.05 ? '#22c55e' : '#ef4444',
                }}
              >
          ...
          {results.lb_pvalue !== null && (
            <div className="metric-card">
              ...
              <div
                className="value"
                style={{
                  color: results.lb_pvalue < 0.05 ? '#22c55e' : '#ef4444',
                }}
              >
            ...
            <div className="metric-card">
              ...
              <small>
                {results.z_ema > 1.0
                  ...
                  : results.z_ema < -1.0
                    ? 'Oversold'
                    : results.z_ema > -0.5 && results.z_ema < 1.0
                      ? 'Sweet spot'
                      : 'Moderate'}
              </small>
            </div>
          ...
          {results.volatility_category !== null && (
            <div className="metric-card">
              ...
              <div className="value">
                {results.volatility_category.replace('_', ' ')}
              </div>
